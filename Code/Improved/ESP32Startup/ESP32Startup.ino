...
void setup() 
{
  ...
  Serial2.begin(115200, SERIAL_8N1, 16, 17); // For Arduino Mega Connection
...
void loop() 
{
  if (Serial2.available())
  {
    ...
    String filteredMessage = filterNonPrintable(message); // Adjust for bad information sent across
